...
export default function NeedRentPage() {
  ...
  return (
    <main className="mx-auto max-w-lg px-4 pb-32 pt-6 sm:px-6">
      <header className="mb-6 flex items-center gap-3 border-b border-[var(--amline-border)] pb-4">
        ...
        <h1 className="amline-title flex-1 text-center text-base text-[var(--amline-fg)]">ثبت نیازمندی — رهن و اجاره</h1>
        <span className="w-11" aria-hidden />
      </header>

      <BuyRentNeedForm mode="rent" />
    </main>
  )
}
